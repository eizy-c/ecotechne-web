  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-brand-black/90 md:bg-gradient-to-r md:from-brand-black md:via-brand-black/80 md:to-transparent z-10" />
        <div 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight leading-none mb-6 animate-fade-in-up">
            Precisión <span className="text-brand-accent">Ingeniería</span><br />
            Innovación <span className="text-gradient">4x4</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-brand-light/70 mb-10 animate-fade-in-up delay-200">
